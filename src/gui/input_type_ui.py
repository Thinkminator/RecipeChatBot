...
from src.gui import text_interface, speech_interface, image_interface
...
def run_input_type_ui(selected_mode):
    ...
    def open_image():
        window.destroy()
        image_interface.run_image_interface(selected_mode)
    ...
    tk.Button(window, text="Image", font=("Arial", 14), width=15, command=open_image).pack(pady=10)
